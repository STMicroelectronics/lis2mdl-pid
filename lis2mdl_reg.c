                                          ...
                                          uint8_t val)
{
  ...
  if (ret == 0)
  {
    reg.off_canc_one_shot = val & 0x01U;
    ret = lis2mdl_write_reg(ctx, LIS2MDL_CFG_REG_B, (uint8_t *)&reg, 1);
  }
                                    ...
                                    lis2mdl_int_on_dataoff_t val)
{
  ...
  if (ret == 0)
  {
    reg.int_on_dataoff = (uint8_t)val & 0x01U;
    ret = lis2mdl_write_reg(ctx, LIS2MDL_CFG_REG_B, (uint8_t *)&reg, 1);
  }
